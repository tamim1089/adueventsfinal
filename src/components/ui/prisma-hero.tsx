"use client";
// NOTE: "use client" added — the original snippet omitted it, but these exports
// use hooks (useRef/useInView/motion) and would fail to import in the App Router
// without it. PrismaHero itself references a remote CDN video + `primary` color
// utilities; it's kept here as provided, but the live site uses WordsPullUp only.
