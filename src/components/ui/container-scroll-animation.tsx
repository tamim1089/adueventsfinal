...
export const ContainerScroll = ({
  ...
  return (
    <div
      ...
      className="h-[52rem] md:h-[72rem] flex items-center justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
...
export const Card = ({
  ...
  <motion.div
    ...
    className="max-w-6xl -mt-8 mx-auto h-[32rem] md:h-[44rem] w-full border-4 border-[#6C6C6C] p-2 md:p-4 bg-[#222222] rounded-[30px] shadow-2xl"
  >
